...
if settings.DEBUG:
    PUSH_NOTIFICATIONS_SETTINGS["APNS_CERTIFICATE"] = PUSH_NOTIFICATIONS_SETTINGS["APNS_CERTIFICATE_PROD"]
    ...
    PUSH_NOTIFICATIONS_SETTINGS["APNS_CERTIFICATE"] = PUSH_NOTIFICATIONS_SETTINGS["APNS_CERTIFICATE_DEV"]
