...
# Compatibility with custom user models, while
# keeping backwards-compatibility with <1.5
...
class GCMDevice(Device):
    # device_id cannot be a reliable primary key as fragmentation
    # between different devices can make it turn out to be null and such:
