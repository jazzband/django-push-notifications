...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GCMDevice', fields ['registration_id']
        db.delete_unique(u'push_notifications_gcmdevice', ['registration_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'GCMDevice', fields ['registration_id']
        db.create_unique(u'push_notifications_gcmdevice', ['registration_id'])
