...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'push_notifications_apnsdevice', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GCMDevice.date_created'
        db.add_column(u'push_notifications_gcmdevice', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'APNSDevice.date_created'
        db.delete_column(u'push_notifications_apnsdevice', 'date_created')

        # Deleting field 'GCMDevice.date_created'
        db.delete_column(u'push_notifications_gcmdevice', 'date_created')
