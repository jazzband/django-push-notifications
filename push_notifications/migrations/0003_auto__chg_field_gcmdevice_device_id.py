...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GCMDevice.device_id'
        db.alter_column('push_notifications_gcmdevice', 'device_id', self.gf('push_notifications.fields.HexIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'GCMDevice.device_id'
        db.alter_column('push_notifications_gcmdevice', 'device_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))
    ...
    models = {
        ...
        'push_notifications.apnsdevice': {
            ...
            'device_id': ('uuidfield.fields.UUIDField', [], {'max_length': '32', 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'push_notifications.gcmdevice': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'device_id': ('push_notifications.fields.HexIntegerField', [], {'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True', 'null': 'True'}),
