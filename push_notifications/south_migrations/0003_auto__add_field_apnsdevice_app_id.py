...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevice.app_id'
        db.add_column(u'push_notifications_apnsdevice', 'app_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevice.app_id'
        db.delete_column(u'push_notifications_apnsdevice', 'app_id')
    ...
    models = {
        ...
        u'push_notifications.apnsdevice': {
            ...
            'app_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
