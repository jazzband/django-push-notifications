...
class APNSPushPayloadTest(TestCase):
    def test_push_payload(self):
        ...
        with mock.patch("push_notifications.apns._apns_pack_frame") as p:
            _apns_send('123', 'Hello world', badge=1, sound='chime', extra={"custom_data": 12345}, expiration=3, socket=socket)
            p.assert_called_once_with(
				'123', '{"aps":{"sound":"chime","badge":1,"alert":"Hello world"},"custom_data":12345}', 0, 3, 10)
